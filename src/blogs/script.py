...
OUTPUT_JS = "blogPosts.js"        # final JS file to use in React
...
with open(OUTPUT_JS, "w", encoding="utf-8") as f:
    ...
    for blog in blogs:
        ...
        f.write("    content: `")
        f.write(textwrap.dedent(blog['content']).replace("`", "\\`"))
        f.write("`\n")
        f.write("  },\n")
    f.write("]\n")

print(f"✅ Exported {len(blogs)} blogs into {OUTPUT_JS}")
