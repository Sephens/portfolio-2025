...
// This would typically come from importing your markdown files
// For now, we'll create a mock based on your sample
const parseMarkdownToBlog = (markdownContent, id) => {
  ...
  return {
    ...
    date: "2025-01-01", // You might want to add this to your frontmatter
...
// Mock blog data - in reality, you'd import your actual markdown files
...
export const getBlogPost = (id) => {
  const markdownContent = blogPostsData[id];
  if (!markdownContent) return null;
  
  return parseMarkdownToBlog(markdownContent, id);
};

export const getAllBlogPosts = () => {
  return Object.keys(blogPostsData).map(id => 
    parseMarkdownToBlog(blogPostsData[id], id)
  );
};